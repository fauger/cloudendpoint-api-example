...
package com.benext.api.userApi;
...
public class UserApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetUser extends UserApiRequest<com.benext.api.userApi.model.User> {
    ...
    protected GetUser(java.lang.Long id) {
      super(UserApi.this, "GET", REST_PATH, null, com.benext.api.userApi.model.User.class);
   ...
   *
   * @param content the {@link com.benext.api.userApi.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.benext.api.userApi.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserApiRequest<com.benext.api.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.benext.api.userApi.model.User content) {
      super(UserApi.this, "POST", REST_PATH, content, com.benext.api.userApi.model.User.class);
    }
